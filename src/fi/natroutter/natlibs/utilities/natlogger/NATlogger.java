...
public class NATlogger {
	...
	@Setter
	private String logTimeFormat = "dd.MM.yyyy-HH:mm:ss";
	...
	// Constructors
	public NATlogger(JavaPlugin plugin, int SaveIntervalSec, int pruneOlderThanDays, boolean consoleLog,
			boolean saveLogs) {
		this.plugin = plugin;
	...
	public void error(String log) {
		Addlog(log, TYPE.ERROR);
	}

	public void warn(String log) {
		Addlog(log, TYPE.WARN);
	}
	...
	public void none(String log) {
		Addlog(log, TYPE.NONE);
	}
